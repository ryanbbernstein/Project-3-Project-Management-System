...
ALTER TABLE `task` ADD CONSTRAINT `task_fk1` FOREIGN KEY (`DELIVERABLE`) REFERENCES `deliverable`(`ID`);
...
ALTER TABLE `issue` ADD CONSTRAINT `issue_fk0` FOREIGN KEY (`ASSOCIATED_TASK`) REFERENCES `task`(`ID`);

ALTER TABLE `issue` ADD CONSTRAINT `issue_fk1` FOREIGN KEY (`RESOURCE`) REFERENCES `resource`(`ID`);
